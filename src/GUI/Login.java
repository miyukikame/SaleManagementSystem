...
public class Login extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel_hideScreen_Log.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                jLabel_hideScreen_LogMouseClicked();
            }

            public void mouseEntered(java.awt.event.MouseEvent evt) {
                jLabel_hideScreen_LogMouseEntered();
            }

            public void mouseExited(java.awt.event.MouseEvent evt) {
                jLabel_hideScreen_LogMouseExited();
            }
        });
    ...
    private void jTextField_Username_LogActionPerformed() {//GEN-FIRST:event_jTextField_Username_LogActionPerformed
    }//GEN-LAST:event_jTextField_Username_LogActionPerformed

    private void jPasswordField_Password_LogActionPerformed() {//GEN-FIRST:event_jPasswordField_Password_LogActionPerformed

    }//GEN-LAST:event_jPasswordField_Password_LogActionPerformed

    private void jButton_Cancel_LogActionPerformed() {//GEN-FIRST:event_jButton_Cancel_LogActionPerformed
        System.exit(0); //close the Login window
    }//GEN-LAST:event_jButton_Cancel_LogActionPerformed

    private void jLabel_hideScreen_LogMouseClicked() {//GEN-FIRST:event_jLabel_hideScreen_LogMouseClicked

        this.setState(JFrame.ICONIFIED);  // minimize the Login screen
    }//GEN-LAST:event_jLabel_hideScreen_LogMouseClicked

    private void jLabel_LogToRegistration_LogMouseClicked() {//GEN-FIRST:event_jLabel_LogToRegistration_LogMouseClicked
    ...
    private void jTextField_Username_LogFocusGained() {//GEN-FIRST:event_jTextField_Username_LogFocusGained
    ...
    private void jTextField_Username_LogFocusLost() {//GEN-FIRST:event_jTextField_Username_LogFocusLost
    ...
    private void jLabel_hideScreen_LogMouseExited() {//GEN-FIRST:event_jLabel_hideScreen_LogMouseExited
        Border label_border = BorderFactory.createMatteBorder(1, 1, 1, 1, Color.black);
        jLabel_hideScreen_Log.setBorder(label_border);
        jLabel_hideScreen_Log.setForeground(Color.black);
    }//GEN-LAST:event_jLabel_hideScreen_LogMouseExited

    private void jPasswordField_Password_LogFocusGained() {//GEN-FIRST:event_jPasswordField_Password_LogFocusGained
    ...
    private void jPasswordField_Password_LogFocusLost() {//GEN-FIRST:event_jPasswordField_Password_LogFocusLost
        String pass_log = String.valueOf(jPasswordField_Password_Log.getPassword());
    ...
    private void jButton_Login_LogMouseEntered() {//GEN-FIRST:event_jButton_Login_LogMouseEntered
        //set button backround
        jButton_Login_Log.setBackground(Color.white);
    }//GEN-LAST:event_jButton_Login_LogMouseEntered

    private void jButton_Login_LogMouseExited() {//GEN-FIRST:event_jButton_Login_LogMouseExited
        jButton_Login_Log.setBackground(Color.green);
    }//GEN-LAST:event_jButton_Login_LogMouseExited

    private void jButton_Login_LogMouseClicked() {//GEN-FIRST:event_jButton_Login_LogMouseClicked
